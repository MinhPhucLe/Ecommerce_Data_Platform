...
# Reference dates
START_2019 = datetime(2019, 10, 21).date()
START_2025 = datetime(2025, 6, 24).date()
...
for i in range(0, 7):
    for hour in range(0, 24):
        ...
        df_res = df_res.select("user_id", "total_suspicious_actions", "type_suspicious", "imported_time", "date",
                               "hour")
